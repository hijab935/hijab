...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "hm") || (event.body.toLowerCase() == "hmm")) {
     return api.sendMessage("️Hmm Hmm Na Kar Mu Me Zuban Nhi Hai Kiya Uska Istemal Karr 😈🤌", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "asslamulaikum") || (event.body.toLowerCase() == "Asslamalaikum") || (event.body.toLowerCase() == "ASSLAM ALAIKUM")) {
...
if ((event.body.toLowerCase() == "I love you") || (event.body.toLowerCase() == "Love you ")) {
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "fuck") || (event.body.toLowerCase() == "Fuck")) {
     return api.sendMessage("🏔️🏝️🅧D 🅚I🅝G🧚🩷🪿 Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣo Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };
