...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "funny bot") || (event.body.toLowerCase() == "chutiya bot")) {
    ...
    if ((event.body.toLowerCase() == "i hate you") || (event.body.toLowerCase() == "hate you")) {
      ...
      if ((event.body.toLowerCase() == "pagl bot") || (event.body.toLowerCase() == "chutiye bot") || (event.body.toLowerCase() == "chumtiya bot") || (event.body.toLowerCase() == "chumtiye bot")) {
     ...
     if ((event.body.toLowerCase() == "🫀") || (event.body.toLowerCase() == "💔")) {
       return api.sendMessage("dil tut gaya to ELFI Lga do na yahan kyu bej rahe ho😀😀😀😂", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "khan") || (event.body.toLowerCase() == "@𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷🪿")) {
       return api.sendMessage("𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷🪿 Boss busy hai Mujhe batao kiya kaam hai🙄", threadID);
     };
    if ((event.body.toLowerCase() == "janu") || (event.body.toLowerCase() == "jan")) {
       return api.sendMessage("Janu me serf Apne boss 𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷🪿 ki hu samjhy", threadID);
     };
   if ((event.body.toLowerCase() == "😂😂😂") || (event.body.toLowerCase() == "😁😁😁")) {
       return api.sendMessage("uff kya hass raha hai jese kisi ladki ne parpose kiya ho😂😂😂😂", threadID);
     };
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "zoya") || (event.body.toLowerCase() == "Sk zoya")) {
       return api.sendMessage("zoya se panga mat lena koi zoya fytr hai g##d faar degi😃🤌", threadID);
     };
       if ((event.body.toLowerCase() == "@Farheen Khan") || (event.body.toLowerCase() == "farheen aap kon ho")) {
     ...
     if ((event.body.toLowerCase() == "moto") || (event.body.toLowerCase() == "🥸")) {
       return api.sendMessage("KHali pet mere demagh ki batti Nahi jalti patlu tum hi kuch socho🤔🤔🤔🤣🤣", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sai Hoga ye system Har koi inbox 📥 Jana chata 😀🙄🙄 ", threadID);
      ...
      if ((event.body.toLowerCase() == "ladki ho")) {return api.sendMessage("Nahi ye bhoot Hai tharki insan 😂😀🙄 ", threadID);
              ...
              if ((event.body.toLowerCase() == "wow")) {return api.sendMessage("Thank you Apko bhi bot chahiya tOo 𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷🪿 se rabta karo👍👍💕" , threadID);
     };
         if ((event.body.toLowerCase() == "👻")) {return api.sendMessage("𝒀𝑬 𝑫𝑬𝑲𝑯 𝑮𝑨𝑹𝑬𝑬𝑩𝑶 𝑲𝑨 BHOOT🤣🤣😅 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "👌")) {return api.sendMessage("𝑻𝒖𝒔𝒊 𝒂𝒘𝒔𝒐𝒎𝒆 𝒉𝒐 𝒈👌👌 ", threadID);
    ...
    if ((event.body.toLowerCase() == "kis kar")) {return api.sendMessage(" ️sab dekh rahe hai wrna bhot kiss deti🙈 ", threadID);
     ...
     if ((event.body.toLowerCase() == "🤭")) {return api.sendMessage("Aasa Kam na Karo Jis me mUH chupa na pary🙄🙄 ", threadID);
     };
       if ((event.body.toLowerCase() == "🥹")) {return api.sendMessage("itne bhi masoom Nahi Ho jitna muh Bana rhi Hai 🥹🥹🙄🙄 ", threadID);
        };
    if ((event.body.toLowerCase() == "🤤")) {return api.sendMessage("Muh se supari nikal rey baba 🤣🤣", threadID);
     ...
     if ((event.body.toLowerCase() == "good night") || (event.body.toLowerCase() == "gn")) {
       return api.sendMessage("️❤️ Good Night too darling my sweet hurt 🥰", threadID, messageID);
     };
     if ((event.body.toLowerCase() == "tharki bot") || (event.body.toLowerCase() == "tharki")) {
       return api.sendMessage("𝐓𝐮𝐦 𝐓𝐚𝐡𝐫𝐤𝐢 𝐓𝐮𝐦𝐡𝐚𝐫𝐢 𝐁𝐯 𝐓𝐡𝐚𝐫𝐤𝐢 𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐁𝐜𝐡𝐞 𝐓𝐡𝐚𝐫𝐤𝐢 𝐓𝐞𝐫𝐚 𝐏𝐮𝐫𝐚 𝐊𝐡𝐚𝐧𝐝𝐚𝐧 𝐓𝐡𝐚𝐫𝐤𝐢🫵🫵🫨", threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me xd king ki setting hu", threadID);
     };

     if ((event.body.toLowerCase() == "shayri") || (event.body.toLowerCase() == "Shayri") || (event.body.toLowerCase() == "SHAYRI") || (event.body.toLowerCase() == "song")) {
       return api.sendMessage( "Na Mai Shayr Hu Na Shayr Ka Bhtija Hu Mai To Apne Ammi Papa Ke Manoranjan Ka Natija Hu😁😂🤣👀",threadID);


     };

     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻☞[𝐎𝐖𝐍𝐄𝐑:☞𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/profile.php?id=61577345783888&mibextid=ZbWKwL☞    his insta id @xdking345 ☜ ༺༒ ༒", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "bot ka malik kon hai")) {
       return api.sendMessage("𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷🎸 ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };

    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is xd king He Gives his name mr xd kingz everywhare", threadID);
     };

     if ((event.body.toLowerCase() == "acha") || (event.body.toLowerCase() == "acha ji")) {
       return api.sendMessage("🤍Hanji meri jaan🙈✨", threadID);
     };
     if ((event.body.toLowerCase() == "ZOYA") || (event.body.toLowerCase() == "zoya")) {
       return api.sendMessage("Hy  kitni peyari hai ZOYA Dekh Kar Hi Dil Karta Zoya Ke Chummi Le Lu💓😘 🙈✨", threadID);
     };


    if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "bye")) {;
      return api.sendMessage("️️️BYE BYE TAKE CARE  SEE YOU SOON BABU😘😘", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
     ...
     if ((event.body.toLowerCase() == "kutiya") || (event.body.toLowerCase() == "kutta")) {
       return api.sendMessage("Same to you dor Fetty muh🤣🤣🤣👌", threadID);
     };

     if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
       return api.sendMessage("sorry malik maaf kr do ab nhi krugi 𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷🎸 please maaf karo na🥺🙏", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "bot kiss me") || (event.body.toLowerCase() == "kiss me")) {
       return api.sendMessage("️Kis khushi me, Me sirf Apne Boss xd king ko kiss karna chahti hu", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "love you")) {     return api.sendMessage("️️️MUJHE I LOVE YOU BOL RHI HO MERE BOSS 𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷 KO BOLO BAHUT HI ACHA BNDA HAI MERA BOSS", threadID);
     };
    if ((event.body.toLowerCase() == "i miss you") || (event.body.toLowerCase() == "miss you too meri jaan❤️😍😘")) {     return api.sendMessage("️️️i miss you too my love ummah 😘😘😘", threadID);
     };

    if ((event.body.toLowerCase() == "i miss you bot") || (event.body.toLowerCase() == " i miss u darling😘😂")) {     return api.sendMessage("️️️i miss you too my love ummah 😘😘😘", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🙄")) {return api.sendMessage("🙄🙄🙄🙄", threadID);
     };
    if ((event.body.toLowerCase() == "🥳")) {return api.sendMessage("OO tery kis ki birthday hai  🎂🎂", threadID);
     };


    if ((event.body.toLowerCase() == "😏")) {return api.sendMessage("Beta Attitude to kusry dikha te hai😀😂😂  ", threadID);
     };

    if ((event.body.toLowerCase() == "😤")) {return api.sendMessage("KIYA HUA ITNI MIRCHI KYU KHAYA THA JO NAK ME SE DhuwA NIKAL GYA 😂😂", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "😜😜")) {return api.sendMessage("Ghndy ishary na kro me xd king bos ko bata dongi 🥺 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍😍")) {return api.sendMessage("bndr jaisi shakl pr dil rakh kr khush ho rhy 🤣 ", threadID);
    ...
    if ((event.body.toLowerCase() == "❤️")) {return api.sendMessage("MEKO KALA DIL CHAHIYE 🙂✨LAL TUT JATA HAI😭👈", threadID);
     };

    if ((event.body.toLowerCase() == "🥰🥰🥰🥰")) {return api.sendMessage("OoHH KIYA BAAT HAI AAJ HAPPY HAPPY HO 🤣", threadID);
     };

  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE MERE BOSS 𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷 KO DEKHO PYARA NA LAGY TO PAISE WAPIS 😝😂 ", threadID);
     };

  if ((event.body.toLowerCase() == "😎😎")) {return api.sendMessage("CHALA JAA BOSDIKE....🤣🤣🤝🏻", threadID);
     };

  if ((event.body.toLowerCase() == "😋😋")) {return api.sendMessage("😒GHR WALO NY AAJ ROTI NHI DALI 🤣🤝🏻", threadID);
     };

  if ((event.body.toLowerCase() == "🧐🧐")) {return api.sendMessage("KIYA DEKH RAHA PAPA KI BARAT A RAHI HAI KIYA 😝", threadID);
     };

  if ((event.body.toLowerCase() == "🥰🥰🥰")) {return api.sendMessage("TU TOO GYAA BETYYY 🤣", threadID);
     };

    if ((event.body.toLowerCase() == "🥵")) {return api.sendMessage("UFFF KITNI GARMI HAI AAJ🥵🥵", threadID);
     };

  if ((event.body.toLowerCase() == "😍")) {return api.sendMessage("IS NAZAR SE MERE OWNER xd king KO DEKHO MAZA NA AY TO PAISE WAPIS 😝😂 ", threadID);
     };

  if ((event.body.toLowerCase() == "😎")) {return api.sendMessage("Chasma hatao na sahab kiya naam hai apka😜😜", threadID);
     };

  if ((event.body.toLowerCase() == "😋")) {return api.sendMessage("GHR WALO NY KHANA NHI DALA AJ TUJHE🥺", threadID);
     };

  if ((event.body.toLowerCase() == "🧐")) {return api.sendMessage("Kuch to gadbad hai dya😂😂🤞🤞", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤣")) {return api.sendMessage("Haasne ki bhi tameez hoti hai tharki🤐😏😹😜", threadID);
     ...
     if ((event.body.toLowerCase() == "assalamualaikum") || (event.body.toLowerCase() == "assalamu alaikum") || (event.body.toLowerCase() == "ASSALAMU ALAIKUM")) {
  ...
  if ((event.body.toLowerCase() == "🤪")) {return api.sendMessage("BaRi MasTi ChaRi Chai TeReKo 1 Ankh Band KRrke ZuBan BAHir Aagyi 😂😂😂", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😘")) {return api.sendMessage("Pehle  Brush Karke aa Badbu aa ri hai😹🤣😂 ", threadID);
    };
  ...
  if ((event.body.toLowerCase() == "Boss")) {return api.sendMessage("mera Boss 𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷 BAHOT cute hai ❤️🥰", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤐")) {
    ...
    if ((event.body.toLowerCase() == "i love you bot") || (event.body.toLowerCase() == "ilove you")) {
     ...
     if ((event.body.toLowerCase() == "fuck") || (event.body.toLowerCase() == "Fuck")) {
       return api.sendMessage("🏔️🏝️ 𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜🧚🩷 Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
     };

    if ((event.body.toLowerCase() == "kese ho bot") || (event.body.toLowerCase() == "kese ho bot babu") || (event.body.toLowerCase() == "main romiyo") || (event.body.toLowerCase() == "main saho") || (event.body.toLowerCase() == "main rounak")) {
