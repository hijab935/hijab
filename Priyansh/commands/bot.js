...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "funny bot") || (event.body.toLowerCase() == "chutiya bot")) {
    ...
    if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😱")) {
       return api.sendMessage("is nazar se serf mere boss 🅧D 🅚I🅝G🧚🩷🪿  dekh sakte hai Mujhe💞", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "khan") || (event.body.toLowerCase() == "@🅧D 🅚I🅝G🧚🩷🪿")) {
       return api.sendMessage("🅧D 🅚I🅝G🧚🩷🪿 Boss busy hai Mujhe batao kiya kaam hai🙄", threadID);
     };
    if ((event.body.toLowerCase() == "janu") || (event.body.toLowerCase() == "jan")) {
       return api.sendMessage("Janu me serf Apne boss 🅧D 🅚I🅝G🧚🩷🪿 ki hu samjhy", threadID);
     };
   if ((event.body.toLowerCase() == "😂😂😂") || (event.body.toLowerCase() == "😁😁😁")) {
    ...
    if ((event.body.toLowerCase() == "zoya") || (event.body.toLowerCase() == "Sk zoya")) {
     ...
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sai Hoga ye system Har koi inbox 📥 Jana chata 😀🙄🙄 ", threadID);
      ...
      if ((event.body.toLowerCase() == "ladki ho")) {return api.sendMessage("Nahi ye bhoot Hai tharki insan 😂😀🙄 ", threadID);
              ...
              if ((event.body.toLowerCase() == "wow")) {return api.sendMessage("Thank you Apko bhi bot chahiya tOo 🅧D 🅚I🅝G🧚🩷🪿 se rabta karo👍👍💕" , threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me xd king ki setting hu", threadID);
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟🅧D 🅚I🅝G🧚🩷🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 🅧D 🅚I🅝G🧚🩷. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/profile.php?id=61577345783888&mibextid=ZbWKwL☞    his insta id @xdking345 ☜ ༺༒ ༒", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "bot ka malik kon hai")) {
       return api.sendMessage("🅧D 🅚I🅝G🧚🩷🎸 ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
     ...
     if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
       return api.sendMessage("sorry malik maaf kr do ab nhi krugi 🅧D 🅚I🅝G🧚🩷🎸 please maaf karo na🥺🙏", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "love you")) {     return api.sendMessage("️️️MUJHE I LOVE YOU BOL RHI HO MERE BOSS 🅧D 🅚I🅝G🧚🩷 KO BOLO BAHUT HI ACHA BNDA HAI MERA BOSS", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE MERE BOSS 🅧D 🅚I🅝G🧚🩷 KO DEKHO PYARA NA LAGY TO PAISE WAPIS 😝😂 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "Boss")) {return api.sendMessage("mera Boss 🅧D 🅚I🅝G🧚🩷 BAHOT cute hai ❤️🥰", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤐")) {
    ...
    if ((event.body.toLowerCase() == "i love you bot") || (event.body.toLowerCase() == "ilove you")) {
     ...
     if ((event.body.toLowerCase() == "fuck") || (event.body.toLowerCase() == "Fuck")) {
       return api.sendMessage("🏔️🏝️ 🅧D 🅚I🅝G🧚🩷 Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
     };
