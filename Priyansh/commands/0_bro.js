...
module.exports.run = async function ({ event, api, args }) {    
  ...
  if (!mention[0]) return api.sendMessage("Kisi 1 ko mantion to kr tutiye 😅", threadID, messageID);
      ...
      return makeImage({ one, two }).then(path => api.sendMessage({ body: "𝐎𝐖𝐍𝐄𝐑 ─━━◉❖𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜†𒁍🧚🩷🪿❖◉━━─                  ▬▬▬▬🌸ᬼ⃝⃪⃘꯭꯭꯭꯭꯭⃡♥️ᬼ⃝⃪⃘꯭⃡❁▬▬▬▬🌸ᬼ⃝⃪⃘꯭꯭꯭꯭꯭⃡♥️ᬼ⃝⃪⃘꯭⃡❁̶꯭꯭꯭̄̎𝄄꯭꯭𝄄꯭꯭꯭𝐂꯭𝄄𝐮꯭𝄄𝄄𝐓꯭𝄄𝄄𝐞꯭𝄄꯭ 𝐛𝐡𝐚𝐢𝄄𝄄꯭𝄄𝐛𝐡𝐞𝐧𝄄꯭𝄄𝄄꯭𝄄❁꯭꯭꯭ᬼ⃝⃪⃘꯭⃡🌸    ✧•❁❁•✧\n\n╔═══❖••° °••❖═══╗\n\n   𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐏𝐚𝐢𝐫𝐢𝐧𝐠\n\n╚═══❖••° °••❖═══╝\n\n   ✶⊶⊷⊷❍⊶⊷⊷✶\n\n       👑𝐘𝐄 𝐋𝐄 𝐌𝐈𝐋 𝐆𝐘𝐀❤\n\n𝐓𝐄𝐑𝐀 𝐁𝐑𝐎𝐓𝐇𝐄𝐑 🩷\n\n   ✶⊶⊷⊷❍⊶⊷⊷✶                    ─━━◉❖𝐈 𝐋𝐎𝐕𝐄 𝐘𝐎𝐔🤗❖◉━━─           ❥═≛𝐒𝐎 𝐌𝐔𝐂𝐇 💝≛═❥                ─━━◉❖𝐌𝐘 𝐁𝐑𝐎𝐓𝐇𝐄𝐑🥰❖◉━━─\nỖ𝐖ηᗴ𝐑◉❖𝗥𝗘𝗦𝗛𝗠𝗔 𝗥𝗔𝗡𝗜❖◉", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
  }
    }
